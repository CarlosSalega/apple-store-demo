export const SITE_CONFIG = {
  ...
  // Hero
  heroTitle: "Somos Apple Store Demo",
  ...
  testimonialsInstagramUrl: "https://instagram.com/applestoredemo",

  // Store
  storeName: "Apple Store Demo",
  ...
  storeInstagram: "applestoredemo",
  storeEmail: "demo@applestore.com",
  ...
  // SEO
  seoTitle: "Apple Store Demo | iPhones y Productos Apple",
  seoDescription:
    "iPhone, iPad, Mac, Watch, Macbook y accesorios Apple nuevos y usados con garantía.",

  // Footer
  footerBrand: "Apple Store Demo",
