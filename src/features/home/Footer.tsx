...
const DEFAULT_BRAND = "Apple Store";
const DEFAULT_TEXT = "Tu mejor opcion en iPhones nuevos y usados con garantia.";
const DEFAULT_INSTAGRAM = "https://instagram.com/applestoredemo";
const DEFAULT_WHATSAPP = "https://wa.me/541155550000";
const DEFAULT_ADDRESS = "Av. Corrientes 1234";
const DEFAULT_PHONE = "+54 11 5555-0000";
