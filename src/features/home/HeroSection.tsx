...
export function HeroSection({
  ...
  return (
    <section
      ref={sectionRef}
      id={id}
      className="bg-surface overflow-x-clip px-4 py-8 md:px-16 md:py-12 lg:px-24 lg:py-16"
    >
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div
          className={`flex justify-center gap-1 transition-all delay-300 duration-700 ${
            mounted && isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-8 opacity-0"
          }`}
      ...
      <div className="flex flex-col items-center pt-8 text-center lg:pt-16">
        <span
          className={`bg-brand/10 text-brand mb-4 inline-block rounded-full px-4 py-1.5 text-xs font-medium transition-all delay-150 duration-700 md:text-sm ${
            mounted && isVisible
              ? "translate-y-0 opacity-100"
        ...
        <h1
          className={`text-text-primary mb-6 max-w-5xl text-4xl font-bold tracking-tight transition-all delay-300 duration-700 md:text-5xl lg:text-6xl ${
            mounted && isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-6 opacity-0"
          }`}
        ...
        <p
          className={`text-text-secondary mb-8 max-w-xl text-lg transition-all delay-500 duration-700 md:text-xl ${
            mounted && isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-6 opacity-0"
          }`}
        ...
        <div
          className={`flex flex-col gap-4 transition-all delay-700 duration-700 sm:flex-row ${
            mounted && isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-6 opacity-0"
          }`}
