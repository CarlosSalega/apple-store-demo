...
export function FeaturedProductsSlider({
  ...
  return (
    <section className="bg-surface mx-auto max-w-7xl overflow-x-clip px-4 py-16 lg:px-24">
      {/* Header */}
      ...
      <div
        ref={trackRef}
        className="md:scrollbar-hidden flex touch-pan-y [scroll-snap-type:x_mandatory] gap-6 overflow-x-auto px-4 pb-4 md:px-8 lg:flex lg:flex-row lg:justify-center md:[-webkit-scrollbar-hidden]:hidden"
