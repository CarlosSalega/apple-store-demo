...
export function PlanCanje({
  ...
  const { refs: stepRefs, visibleItems: stepVisible } =
    useScrollRevealMultiple(3);
  ...
  return (
    <section
      ...
      id={id}
      className={cn(
        "bg-surface overflow-x-clip px-4 py-8 md:px-16 md:py-12 lg:px-24 lg:py-16",
        className,
      )}
    >
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 lg:gap-16">
        ...
        <div className="space-y-8">
          ...
          <p
            className={cn(
              "text-muted-foreground mt-3 px-4 text-lg transition-all delay-150 duration-700",
              mounted && isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-6 opacity-0",
            )}
          ...
          <div
            className={cn(
              "flex flex-wrap gap-4 px-4 transition-all delay-500 duration-700",
              mounted && isVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-6 opacity-0",
            )}
        ...
        <Card
          className={cn(
            "transition-all delay-300 duration-700 sm:px-4",
            mounted && isVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-6 opacity-0",
          )}
